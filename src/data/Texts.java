...
public class Texts {
    ...
    public static final String[] MAIN_MENU = { "Chiffrer un mot de passe", "Déchiffrer un mot de passe", "Hacher un mot de passe", "Générer un nombre entier pseudo-aléatoire", "Cacher un message en stéganographie", "Quitter" };
